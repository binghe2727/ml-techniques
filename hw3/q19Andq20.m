...
for i=1:100    
    ...
    for j=1:300        
        ...
        [gt,iMin,sMin,thetaMin,r ] = DTreePredictPruned( pareNodeValue,trainData,r,order );
        %%%%%%%%%%%%%% do the predict for all data
        testData=load('hw3_train.dat'); %only for the q15;cancel it for q19
        testData=load('hw3_test.dat');  %only for the q15;cancel it for q20
    ...
    %%%%%%%%%%all error sum
    errorAll=errorAll+errorNow;
end
errorPrint=errorAll/100;